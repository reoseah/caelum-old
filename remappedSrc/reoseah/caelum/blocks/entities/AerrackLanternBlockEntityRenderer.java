package reoseah.caelum.blocks.entities;
...
public class AerrackLanternBlockEntityRenderer extends BlockEntityRenderer<AerrackLanternBlockEntity> {
	...
	public static final Block AERRACK_LANTERN_OVERLAY_DUMMY = new Block(FabricBlockSettings.of(Material.AIR).lightLevel(13));
	...
	public void render(AerrackLanternBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
		...
		mc.getBlockRenderManager()
				.getModelRenderer()
				.render(entity.getWorld(), model, AERRACK_LANTERN_OVERLAY_DUMMY.getDefaultState(), pos, matrices, vertexConsumers.getBuffer(RenderLayer.getCutout()), true, entity.getWorld().getRandom(), 1, 0xFFFFFF);
		matrices.pop();
	}
}
