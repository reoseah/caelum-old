package reoseah.caelum.features.structures.pieces;
...
public class PillarIslandPiece extends BaseIslandPiece {
	...
	@Override
	public boolean generate(StructureWorldAccess world, StructureAccessor structures, ChunkGenerator generator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
