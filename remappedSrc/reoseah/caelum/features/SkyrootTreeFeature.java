...
public class SkyrootTreeFeature extends CaelumTreeFeature<SkyrootConfig> {
	...
	@Override
	public boolean generate(StructureWorldAccess world, StructureAccessor structures, ChunkGenerator generator, Random random, BlockPos pos, SkyrootConfig config) {
