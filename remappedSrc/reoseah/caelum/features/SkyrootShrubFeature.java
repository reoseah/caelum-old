...
public class SkyrootShrubFeature extends CaelumTreeFeature<SkyrootConfig> {
	...
	@Override
	public boolean generate(StructureWorldAccess world, StructureAccessor accessor, ChunkGenerator generator, Random random, BlockPos pos, SkyrootConfig config) {
