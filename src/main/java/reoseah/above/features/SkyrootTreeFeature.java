...
public class SkyrootTreeFeature extends AbstractTreeFeature<SkyrootTreeConfig> {
	public SkyrootTreeFeature(Function<Dynamic<?>, ? extends SkyrootTreeConfig> function) {
		super(function);
	}

	@Override
	protected boolean generate(ModifiableTestableWorld world, Random random, BlockPos pos, Set<BlockPos> logPositions, Set<BlockPos> leavesPositions, BlockBox box, SkyrootTreeConfig config) {
