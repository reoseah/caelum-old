...
public class SkyrootBushFeature extends AbstractTreeFeature<TreeFeatureConfig> {
	public SkyrootBushFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> function) {
		super(function);
	}
