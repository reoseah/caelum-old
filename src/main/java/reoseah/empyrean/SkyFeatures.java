...
import reoseah.empyrean.world.features.AerrackOreFeature;
import reoseah.empyrean.world.features.DwarfSkyrootTreeFeature;
import reoseah.empyrean.world.features.SkyrootBushWithSoilFeature;
import reoseah.empyrean.world.features.SkyrootFeatureConfig;
import reoseah.empyrean.world.features.SkyrootGroundBushFeature;
import reoseah.empyrean.world.features.SkyrootTallBushFeature;
import reoseah.empyrean.world.features.SkyrootTreeFeature;
import reoseah.empyrean.world.structures.LargeIslandStructureFeature;
...
public class SkyFeatures {
	...
	private static void register(String name, Feature<?> feature) {
		Registry.register(Registry.FEATURE, Empyrean.makeID(name), feature);
	}

	private static void registerStructure(String name, StructureFeature<?> feature) {
		Registry.register(Registry.STRUCTURE_FEATURE, Empyrean.makeID(name), feature);
	}
}
