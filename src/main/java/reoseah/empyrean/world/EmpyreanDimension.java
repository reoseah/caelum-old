...
import reoseah.empyrean.SkyBiomes;
import reoseah.empyrean.Empyrean;

public class EmpyreanDimension extends Dimension {
	public EmpyreanDimension(World world, DimensionType type) {
		super(world, type, 0.1F);
	}

	@Override
	public ChunkGenerator<?> createChunkGenerator() {
		return new EmpyreanChunkGenerator(world,
				new FixedBiomeSource(new FixedBiomeSourceConfig(world.getSeed()).setBiome(SkyBiomes.BARREN_FOREST)),
				new EmpyreanChunkGeneratorConfig());
	}
	...
	public DimensionType getType() {
		return Empyrean.DIMENSION_TYPE;
	}
