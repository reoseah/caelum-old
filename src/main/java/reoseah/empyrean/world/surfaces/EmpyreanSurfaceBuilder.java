...
public class EmpyreanSurfaceBuilder extends SurfaceBuilder<TernarySurfaceConfig> {
	public EmpyreanSurfaceBuilder(Function<Dynamic<?>, ? extends TernarySurfaceConfig> deserialize) {
		super(deserialize);
	}
