...
public class CeruclaseRockcutterItem extends MiningToolItem {
	...
	public CeruclaseRockcutterItem(ToolMaterial material, float speed, float damage, Item.Settings settings) {
