...
public class SkyrootDiggingStickItem extends MiningToolItem {
	...
	public SkyrootDiggingStickItem(ToolMaterial material, float speed, float damage, Item.Settings settings) {
