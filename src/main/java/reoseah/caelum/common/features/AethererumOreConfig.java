...
public class AethererumOreConfig implements FeatureConfig {
    public final int size;
    public final BlockState state;

    public AethererumOreConfig(BlockState state, int size) {
        this.size = size;
        this.state = state;
    }
    ...
    public static AethererumOreConfig deserialize(Dynamic<?> dynamic) {
        ...
        return new AethererumOreConfig(state, size);
    }
}
