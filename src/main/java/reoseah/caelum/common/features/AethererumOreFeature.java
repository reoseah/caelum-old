...
public class AethererumOreFeature extends Feature<AethererumOreConfig> {
    private static final Block AETHERERUM_ORE = CaelumBlocks.AETHERERUM_ORE;

    public AethererumOreFeature(Function<Dynamic<?>, ? extends AethererumOreConfig> configDeserializer) {
        super(configDeserializer);
    }

    @Override
    public boolean generate(IWorld world, ChunkGenerator<? extends ChunkGeneratorConfig> generator, Random random, BlockPos pos, AethererumOreConfig config) {
    ...
    protected boolean generateVeinPart(IWorld world, Random random, AethererumOreConfig config, double startX, double endX, double startZ, double endZ, double startY, double endY, int x, int y, int z, int width, int height) {
        int count = 0;
                                ...
                                for (int int_19 = int_13; int_19 <= int_16; ++int_19) {
                                    ...
                                    if (double_20 * double_20 + double_21 * double_21 + double_22 * double_22 < 1.0D) {
                                        ...
                                        if (!bitset.get(int_20)) {
                                            ...
                                            if (world.getBlockState(pos).getBlock() == AETHERERUM_ORE) {
