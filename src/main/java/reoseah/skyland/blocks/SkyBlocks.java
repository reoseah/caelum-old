...
public class SkyBlocks {
	...
	public static void register() {
		...
		register("skyroot_log", new BlockItem(SKYROOT_LOG, new Item.Settings().group(Skyland.GROUP)));
		register("skyroot_leaves", new BlockItem(SKYROOT_LEAVES, new Item.Settings().group(Skyland.GROUP)));
		...
		register("skyroot_sapling", new BlockItem(SKYROOT_SAPLING, new Item.Settings().group(Skyland.GROUP)));
