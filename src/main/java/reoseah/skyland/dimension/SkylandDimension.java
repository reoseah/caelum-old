...
import reoseah.skyland.dimension.chunk.SkylandGenerator;

public class SkylandDimension extends Dimension {
	public SkylandDimension(World world, DimensionType type) {
		super(world, type, 0.1F);
	}

	@Override
	public ChunkGenerator<?> createChunkGenerator() {
		return new SkylandGenerator(world,
